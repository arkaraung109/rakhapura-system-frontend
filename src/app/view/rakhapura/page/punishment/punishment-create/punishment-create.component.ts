...
@Component({
  selector: 'app-punishment-create',
  templateUrl: './punishment-create.component.html',
  styleUrls: ['./punishment-create.component.css']
})
  ...
  submit() {
    ...
    dialogRef.afterClosed().subscribe(result => {
      if (result) {
        ...
        let punishment = this.submitForm.get('punishment')!.value;
        let description = this.submitForm.get('description')!.value;
        let eventDate = this.submitForm.get('eventDate')!.value;
        let startDate = this.submitForm.get('startDate')!.value;
        let endDate = this.submitForm.get('endDate')!.value;
        ...
        this.punishmentService.save(requestBody, this.idList).subscribe({
